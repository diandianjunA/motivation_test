...
TEST(DataGenerateTest, BasicTest) {
    ...
    DataConfig test_config = {
        ...
        /*output_dir=*/"/data/xjs/random_dataset/1024dim5M",
    };
    ...
    // 生成并验证
    exp_gen.generate_experiment("1024dim5M", true);
    
    // 加载并展示部分数据
    RandomDataGenerator data_gen(test_config);
    auto database = data_gen.load_vectors("/data/xjs/random_dataset/1024dim5M/base.fbin");
