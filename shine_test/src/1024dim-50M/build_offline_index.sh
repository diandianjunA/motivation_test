...
DATA_PATH="${DATA_PATH:-/data/xjs/random_dataset/1024dim50M/base.fbin}"
OUTPUT_PREFIX="${OUTPUT_PREFIX:-/data/xjs/index/shine_index/1024dim50M}"
MEMORY_NODES="${MEMORY_NODES:-5}"
THREADS="${THREADS:-0}"
M="${M:-64}"
EF_CONSTRUCTION="${EF_CONSTRUCTION:-320}"
MAX_VECTORS="${MAX_VECTORS:-50000000}"
SEED="${SEED:-1234}"
