...
DATA_PATH="${DATA_PATH:-/data/xjs/random_dataset/1024dim5M}"
OUTPUT_PREFIX="${OUTPUT_PREFIX:-/data/xjs/index/shine_index/1024dim5M}"
MEMORY_NODES="${MEMORY_NODES:-1}"
THREADS="${THREADS:-0}"
M="${M:-40}"
EF_CONSTRUCTION="${EF_CONSTRUCTION:-220}"
MAX_VECTORS="${MAX_VECTORS:-7500000}"
SEED="${SEED:-1234}"
