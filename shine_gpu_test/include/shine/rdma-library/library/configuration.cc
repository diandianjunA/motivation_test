...
void Configuration::create_rdma_options() {
  desc.add_options()("help,h", "Show help message")(
    ...
    "A list of server IPs or aliases to which a client connects, e.g., \"192.168.6.201 192.168.6.202\"")(
    "clients",
    po::value<vec<str>>(&client_nodes)->multitoken(),
    "A list of client IPs or aliases to which the initiator connects, e.g., "
